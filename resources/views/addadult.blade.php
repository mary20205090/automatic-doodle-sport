...
<body>
 ...
 <section class="home-section">
  ...
  <div class="mb-3">
    ...
    <input type="text" placeholder="Enter FirstName" class="form-control" name="fname" > <br>
  </div>
  <div class="mb-3">
    <label for="mname" class="form-label">Middle  Name</label><br>
    <input type="text"  placeholder="Enter MiddleName"class="form-control" name="mname" ><br>
  </div>
 <div class="mb-3">
    <label for="lname" class="form-label">Last  Name</label> <br>
    <input type="text" placeholder="Enter LastName" class="form-control" name="lname" > <br>
  </div>
<button type="submit" class="btn btn-primary">Register Adult</button>
</form>
</div>
