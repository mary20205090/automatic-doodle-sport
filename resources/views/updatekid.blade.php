...
<body>
 ...
 <section class="home-section">
  ...
  <div class="row">
   ...
   <form  method="POST"action="/updatekid"  >
    @csrf
  <div class="mb-3">
...
<select name="kid_id"  class="form-control" >
                @forelse($fetchKids  as $kid)
                     <option value="{{$kid->id}}">{{ $kid->fname}}</option>
                @empty
 ...
 <div class="mb-3">
    ...
    <select name="game" class="form-control">
                ...
                <option value="Kiddie train">Kiddie train</option>
                <option value="Mascots">Mascots</option>
                <option value="Facepainting">Facepainting</option> 
                <option value="Mr Clown/Acrobats/Magic show">Mr Clown/Acrobats/Magic show</option>
                <option value="Art village">Art village</option>
                <option value="Puppetry">Puppetry</option>
                <option value="Kiddie kareoke">Kiddie kareoke</option>
                <option value="Obstacle bouncy castle">Obstacle bouncy castle</option>
                <option value="Quadbikes">Quadbikes</option>
                <option value="Bubble football">Bubble football</option>
        </select>
    </div>

    <div class="mb-3">
    <label for="points" class="form-label">Enter Points</label>
