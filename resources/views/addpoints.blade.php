...
<select name="adult_id"  class="form-control" >
                @forelse($fetchAdults  as $adult)
                     <option value="{{$adult->id}}">{{ $adult->fname}}</option>
                @empty
 ...
 <div class="mb-3">
    ...
    <select name="game" class="form-control">
                ...
                <option value="Wrecking ball Inflatable">Wrecking ball Inflatable</option>
                <option value="Mobile basket ball post(kids)">Mobile basket ball post(kids)</option>
                ...
                <option value="Mobile basket ball post">Mobile basket ball post</option>
                <option value="VR">VR</option>
                <option value="Just Dance">Just Dance</option>
                <option value="F1 simulator">F1 simulator</option>
                 </select>
    </div>
