 ...
 <section class="home-section">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="addkid" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="mname" placeholder="Enter MidlleName" class="form-control"><br>
                </div>
                ...
                <input type="submit" value="Register Kids" class="btn btn-primary"><br>
            </form>
        </div>
    </div>
