            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <a class="btn btn-primary" href="viewpoints" aria-label="Delete">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  <div class="col-5 col-md-4">
                  <a class="btn btn-primary" href="viewkid" aria-label="Delete">
                  <i class="fa fa-users fa-2x" aria-hidden="true"></i>
                  </a>
                  </div>
                  <div class="col-7 col-md-8">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  <div class="col-5 col-md-4">
                  <a class="btn btn-primary" href="home" aria-label="Delete">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category"> Best Score</p>
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ...
                foreach ($point as $user) {
                    echo "['" . $user->id . "', '" . $user->game . "', '" . $user->points . "'],";
                }
                @endphp
            ]);
            ...
            var options = {
                chart: {
                    title: 'Bar Graph | Adults',
                    subtitle: 'Adults, and Game Name: @php echo $point[0]->created_at @endphp',
                },
                bars: 'vertical'
            };
